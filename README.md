...
This particular implementation of regular expressions guarantees execution in
linear time with respect to the size of the regular expression. Much of the
syntax and implementation is inspired by [RE2](https://github.com/google/re2).
