...
* When given the choice between faster regex searches and faster _*Rust compile
times*_, this crate will generally choose faster regex searches.
* When given the choice between faster regex searches and faster _*regex compile
times*_, this crate will generally choose faster regex searches. That is, it is
